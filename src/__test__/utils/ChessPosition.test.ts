...
describe("Position constructed correctly", () => {
  test("x and y are set correctly", () => {
    const position = new Knight(10, 5);
...
describe("Position hash value", () => {
  test("Returns hash value that is equal for same Position cords", () => {
    let position = new Knight(5, 10);
    let position2 = new Knight(5, 10);
    expect(position.hash()).toBe(position2.hash());

    position = new Knight(0, 0);
    position2 = new Knight(0, 0);
    expect(position.hash()).toBe(position2.hash());

    position = new Knight(1, 2);
    position2 = new Knight(1, 2);
    expect(position.hash()).toBe(position2.hash());

    position = new Knight(20, -5);
    position2 = new Knight(20, -5);
    expect(position.hash()).toBe(position2.hash());
  });

  test("Hash value is differnt for different position cords", () => {
    let position = new Knight(5, 10);
    let position2 = new Knight(2, 10);
    expect(position.hash()).not.toBe(position2.hash());

    position = new Knight(0, 0);
    position2 = new Knight(0, 1);
    expect(position.hash()).not.toBe(position2.hash());

    position = new Knight(1, 2);
    position2 = new Knight(1, 5);
    expect(position.hash()).not.toBe(position2.hash());

    position = new Knight(20, -5);
    position2 = new Knight(2, -5);
    expect(position.hash()).not.toBe(position2.hash());

    position = new Knight(2, 1);
    position2 = new Knight(1, 2);
    expect(position.hash()).not.toBe(position2.hash());

    position = new Knight(10, 20);
    position2 = new Knight(20, 10);
    expect(position.hash()).not.toBe(position2.hash());
  });
